async function $33c0128acbec5ff2$export$a5575dbeeffdad98(file) {
    const MAX_FILE_SIZE = ($33c0128acbec5ff2$export$a5575dbeeffdad98.MAX_FILE_SIZE_IN_MB || 200) * 1000000;
    if (!file) throw new Error(`file is required`);
    if (file.size > MAX_FILE_SIZE) throw new Error(`"${file.name}" is too big. Please select a file smaller ` + `than ${$33c0128acbec5ff2$export$a5575dbeeffdad98.MAX_FILE_SIZE_IN_MB}mb.`);
