import {useCallback as $keieZ$useCallback, useEffect as $keieZ$useEffect, useRef as $keieZ$useRef, useMemo as $keieZ$useMemo, useState as $keieZ$useState} from "react";
...
function $27954de794c56674$export$2e2bcd8739ae039(asyncFunction, config = {}) {
    ...
    const callbacks = (0, $keieZ$useRef)();
