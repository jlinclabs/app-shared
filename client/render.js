...
const $08b8c86ef070e3a0$var$Link = /*#__PURE__*/ $h2dLv$forwardRef(({ ...props }, ref)=>{
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialLink), {
        ...props,
        ref: ref
    }, void 0, false, {
...
function $1abdbf2868e540b2$export$2e2bcd8739ae039({ disabled: disabled , children: children , onSubmit: onSubmit , ...props }) {
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
        component: "form",
        disabled: disabled,
        ...props,
        onSubmit: _onSubmit,
...
function $33fea69a0e10afc7$export$2e2bcd8739ae039({ children: children , ...props }) {
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialStack), {
        spacing: 2,
...
const $e57fa53a045bcfbf$var$ErrorMessage = ({ error: error , ...props })=>{
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialAlert), {
        severity: "error",
        ...props,
        children: error.message
    }, void 0, false, {
...
function $bd5e7b1f34144514$export$2e2bcd8739ae039({ APP_NAME: APP_NAME  }) {
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialContainer), {
        maxWidth: false,
        disableGutters: true,
        children: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
            sx: {
                display: "flex",
                flexDirection: "row",
                minHeight: "100vh",
            ...
            children: [
                /*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$SideNav, {
                    spec: spec
                }, void 0, false, {
                ...
                /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
                    ...
                    children: [
                        /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $e57fa53a045bcfbf$exports.default), {
                            error: error
                        }, void 0, false, {
                            fileName: "client-src/pages/DebugPage.js",
                            lineNumber: 69,
                        ...
                        /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$ErrorBoundary), {
                            FallbackComponent: (0, $398477c469915369$export$2e2bcd8739ae039),
                            children: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$Routes), {
                                children: [
                                    /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$Route), {
                                        path: "/q/:name",
                                        element: /*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$ExecForm, {
                                            ...props,
                                            type: "query"
...
function $bd5e7b1f34144514$var$SideNav({ spec: spec  }) {
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$SideNavButton, {
                to: `/`,
                icon: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muiiconsmaterialCottage), {}, void 0, false, void 0, void 0),
                title: "Home"
            }, void 0, false, {
                fileName: "client-src/pages/DebugPage.js",
                lineNumber: 104,
            ...
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$SideNavButtonList, {
                name: "Queries",
                types: spec?.queries,
                icon: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muiiconsmaterialHelpOutline), {}, void 0, false, void 0, void 0),
                linkPrefix: "/debug/q/"
            }, void 0, false, {
                fileName: "client-src/pages/DebugPage.js",
                lineNumber: 109,
            ...
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$SideNavButtonList, {
                name: "Commands",
                types: spec?.commands,
                icon: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muiiconsmaterialKeyboardCommandKeyTwoTone), {}, void 0, false, void 0, void 0),
                linkPrefix: "/debug/c/"
            }, void 0, false, {
                fileName: "client-src/pages/DebugPage.js",
                lineNumber: 115,
...
function $bd5e7b1f34144514$var$SideNavButton({ icon: icon , title: title , subtitle: subtitle , ...props }) {
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialListItem), {
        disablePadding: true,
        children: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialListItemButton), {
            ...props,
            children: [
                /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialListItemIcon), {
                    sx: {
                        minWidth: "30px"
                    },
                    children: icon
                ...
                /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialListItemText), {
                    primary: title,
                    secondary: subtitle
                }, void 0, false, {
                    fileName: "client-src/pages/DebugPage.js",
...
function $bd5e7b1f34144514$var$SideNavButtonList({ name: name , types: types , icon: icon , linkPrefix: linkPrefix  }) {
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
        children: [
            ...
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialList), {
                dense: true,
                sx: {
                    pt: 0
                },
                children: Array.isArray(types) ? [
                    ...types
                ].sort().map(({ name: name , args: args  })=>/*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$SideNavButton, {
                        key: name,
                        to: `${linkPrefix}${name}`,
                        icon: icon,
                        title: name,
                        ...
                        lineNumber: 142,
                        columnNumber: 11
                    }, this)) : Array(3).fill().map((_, i)=>/*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialSkeleton), {
                        animation: "wave",
                        height: "40px"
                    }, i, false, {
                        fileName: "client-src/pages/DebugPage.js",
...
function $bd5e7b1f34144514$var$ExecForm({ spec: spec , type: type , name: name , optionsJson: optionsJson = "{}"  }) {
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
        children: [
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $1abdbf2868e540b2$export$2e2bcd8739ae039), {
                disabled: disabled,
                onSubmit: onSubmit,
                children: /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialStack), {
                    spacing: 2,
                    children: [
                        /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialStack), {
                            direction: "row",
                            spacing: 2,
                            children: [
                                /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialTypography), {
                                ...
                                /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialSelect), {
                                    value: name,
                                    // onChange={e => setName(e.target.value)}
                                    autoWidth: true,
                                    children: names.map(({ name: name  })=>/*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialMenuItem), {
                                            value: name,
                        ...
                        /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialTextField), {
                            disabled: disabled,
                            label: "options (JSON)",
                            fullWidth: true,
                            multiline: true,
                        ...
                        /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $33fea69a0e10afc7$export$2e2bcd8739ae039), {
                            sx: {
                                mt: 2
                            },
                            children: [
            ...
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)("hr", {}, void 0, false, {
                fileName: "client-src/pages/DebugPage.js",
                lineNumber: 249,
                columnNumber: 5
            }, this),
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
                children: execution ? /*#__PURE__*/ (0, $h2dLv$jsxDEV)(Exec, {
                    key: execution.id,
                    id: execution.id,
                    name: name,
...
function $bd5e7b1f34144514$var$ExecuteQuery({ id: id , name: name , options: options , onComplete: onComplete  }) {
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)($bd5e7b1f34144514$var$Execution, {
        ...results,
        name: name,
        options: options
    }, void 0, false, {
...
function $bd5e7b1f34144514$var$Execution({ name: name , options: options , result: result , loading: loading , error: error  }) {
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialBox), {
        children: loading ? /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $h2dLv$muimaterialCircularProgress), {}, void 0, false, {
            fileName: "client-src/pages/DebugPage.js",
            lineNumber: 287,
            columnNumber: 11
        }, this) : error ? /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $e57fa53a045bcfbf$exports.default), {
            error: error
        }, void 0, false, {
            fileName: "client-src/pages/DebugPage.js",
            lineNumber: 289,
            columnNumber: 13
        }, this) : /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $b5643637aedb000b$export$2e2bcd8739ae039), {
            object: result,
            sx: {
                m: 0,
...
function $bd5e7b1f34144514$var$Command({ name: name , options: options , ...prop }) {
    ...
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)(Tile, {
        title: `command: ${name}`,
        ...prop,
        children: [
            /*#__PURE__*/ (0, $h2dLv$jsxDEV)((0, $b5643637aedb000b$export$2e2bcd8739ae039), {
                object: {
                    options: options
                }
            }, void 0, false, {
...
function $8ea33c689192dd62$export$2e2bcd8739ae039() {
    return /*#__PURE__*/ (0, $h2dLv$jsxDEV)("div", {
        children: "Page Not Found"
    }, void 0, false, {
        fileName: "client-src/pages/NotFoundPage.js",
        lineNumber: 4,
        columnNumber: 10
    }, this);
}
