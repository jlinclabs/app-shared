        ...
        children: [
            ...
            /*#__PURE__*/ (0, $d8gED$jsx)((0, $d8gED$muimaterialList), {
                ...
                children: Array.isArray(types) ? [
                    ...types
                ].sort().map(({ name: name , args: args  })=>/*#__PURE__*/ (0, $d8gED$jsx)($bd5e7b1f34144514$var$SideNavButton, {
                        key: name,
                        to: `${linkPrefix}${name}`,
                        icon: icon,
                        title: name,
                        subtitle: args
                    })) : Array(3).fill().map((_, i)=>/*#__PURE__*/ (0, $d8gED$jsx)((0, $d8gED$muimaterialSkeleton), {
                        animation: "wave",
                        height: "40px"
                    }, i))
            })
                        ...
                        /*#__PURE__*/ (0, $d8gED$jsxs)((0, $d8gED$muimaterialStack), {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, $d8gED$jsx)((0, $d8gED$muimaterialSelect), {
                                    ...
                                    autoWidth: true,
                                    children: names.map(({ name: name  })=>/*#__PURE__*/ (0, $d8gED$jsx)((0, $d8gED$muimaterialMenuItem), {
                                            value: name,
...
function $bd5e7b1f34144514$var$Command({ name: name , options: options , ...prop }) {
    ...
    return /*#__PURE__*/ (0, $d8gED$jsxs)(Tile, {
        title: `command: ${name}`,
        ...prop,
        children: [
            /*#__PURE__*/ (0, $d8gED$jsx)((0, $b5643637aedb000b$export$2e2bcd8739ae039), {
